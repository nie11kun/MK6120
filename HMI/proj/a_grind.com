...
//M(Mask1/$85075//);工件参数
	...
	DEF CAO_INIT=(I/0,//$85185,$85185,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[260]"/10,170,110/110,170,60//);起始磨削槽
	DEF CAO_END=(I/0,//$85186,$85186,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[261]"/10,190,110/110,190,60//);终止磨削槽
	...
	DEF YUAN_DIA=(R/0,//$85988,$85988,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[262]"/360,150,110/460,150,60//);圆拉刀-外径
	DEF CAO_COUNT=(I/0,//$85184,$85184,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[259]"/360,170,110/460,170,60//);圆拉刀-槽数
...
//M(Mask5/$85079//);顶刃磨削
	...
	DEF POS_INPUT_7=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,220,18/);坐标写入键

	DEF GRIND_C=(R/0,360//$85984,$85984,,$85042/WR4//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[281]"/360,240,110/460,240,110//"UserGuide/section_1.html","S1D44");C轴起始位
	DEF POS_INPUT_9=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/530,240,18/);坐标写入键
...
//M(Mask3/$85077//);平磨参数
	...
	DEF POS_INPUT_7=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/530,200,18/);坐标写入键
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF POS_INPUT_9=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/530,220,18/);坐标写入键
...
//M(Mask11/$85094/"panel_1_1_chs.png"/)
	...
	DEF C_IM=(R///$85120,$85120,,/WR1,ac4//"$AA_IM[C]"/10,50,20/30,50,60/3);C_IM
	...
	DEF X_CENTER=(R///$85180,$85180,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[258]"/360,140,202/460,140,60//);工件中心位置X
	...
	DEF GRIND_A_ADDON=(R///$85987,$85987,,$85042/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[284]"/360,330,110/460,330,110//);升角补偿.A

	DEF GRIND_B=(R///$85925,$85925,,$85042/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[245]"/360,350,110/460,350,110/);B轴磨削位
