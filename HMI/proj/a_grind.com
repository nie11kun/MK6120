...
//M(Mask4/$85078//);前刃磨削
	...
	DEF Y_POSITION_INIT=(R///$85921,$85921,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[232]"/360,190,202/460,190,60//"UserGuide/section_1.html","S1D46");初始磨削接触位

	DEF DIMIANCISHENG=(I/*0=$85157,1=$85162//$85156,$85156,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[92]"/360,220,202/460,220,60//);底面加工是否有齿升量-0没有/1有
	DEF JINDAOMODE=(I/*0=$85190,1=$85191//$85189,$85189,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[95]"/360,240,202/460,240,60//);前刃后背加工是否斜向进刀(0否1是)
	DEF CIJU_MODE=(I/*0=$85194,1=$85195//$85193,$85193,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[97]"/360,270,202/460,270,60//);磨削齿距模式(0测量齿距/1标准齿距)
...
//M(Mask6/$85080//);后背磨削
	...
	DEF Y_POSITION_INIT=(R///$85921,$85921,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[233]"/360,190,202/460,190,60//"UserGuide/section_1.html","S1D46");初始磨削接触位
...
//M(Mask5/$85079//);顶刃磨削
	...
	DEF Y_POSITION_INIT=(R///$85921,$85921,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[234]"/360,190,202/460,190,60//"UserGuide/section_1.html","S1D46");初始磨削接触位
...
//M(Mask3/$85077//);平磨参数
	...
	DEF Y_POSITION_CURR=(R///$85936,$85936,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[237]"/360,50,202/460,50,60//"UserGuide/section_1.html","S1D46");当前磨削接触位

	DEF GRIND_X=(R///$85132,$85132,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[40]"/360,80,110/460,80,60//);齿形平磨初始位x
	DEF GRIND_BUCHANG=(R///$85192,$85192,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[96]"/360,100,110/460,100,60//);通磨长度延长量

	DEF GRIND_A=(R///$85924,$85924,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[46]"/360,130,110/460,130,110//"UserGuide/section_1.html","S1D44");A轴磨削位
	DEF GRIND_B=(R///$85925,$85925,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[47]"/360,150,110/460,150,110//"UserGuide/section_1.html","S1D44");B轴磨削位
	DEF GRIND_SAFE=(R///$85172,$85172,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[48]"/360,170,202/460,170,60//"UserGuide/section_1.html","S1D13");磨削安全位置  ifIsExternal
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF Y_POSITION_INIT=(R///$85921,$85921,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[236]"/360,30,202/460,30,60//"UserGuide/section_1.html","S1D46");初始磨削接触位

	DEF GRIND_X=(R///$85132,$85132,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[72]"/360,60,110/460,60,60//);磨削位x
	DEF LENGTH_CI=(R///$85133,$85133,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[73]"/360,80,110/460,80,60//);齿厚

	DEF GRIND_A=(R///$85924,$85924,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[68]"/360,110,110/460,110,110//"UserGuide/section_1.html","S1D44");A轴磨削位
	DEF GRIND_B=(R///$85925,$85925,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[69]"/360,130,110/460,130,110//"UserGuide/section_1.html","S1D44");B轴磨削位
	DEF GRIND_SAFE=(R///$85172,$85172,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[70]"/360,150,202/460,150,60//"UserGuide/section_1.html","S1D13");磨削安全位置  ifIsExternal
