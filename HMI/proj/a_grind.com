...
//M(Mask4/$85078//);前刃磨削
	...
	DEF TONGMO_MODE=(I/*0=$85110,1=$85111//$85109,$85109,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[348]"/180,30,202/250,30,60/,"#ffc5c5"/);前角 后背-通磨是否有进刀量-用于通磨没有进刀量但齿底有进刀量情况加工(0有 1无)
	...
	LOAD
		...
		IF (TONGMO_MODE.VAL<>0) AND (TONGMO_MODE.VAL<>1)
			TONGMO_MODE.VAL=0
		ENDIF
