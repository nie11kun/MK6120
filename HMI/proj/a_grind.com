...
//M(Mask3/$85077//);平磨参数
	...
	DEF Y_POSITION_INIT=(R///$85921,$85921,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[235]"/360,30,202/460,30,60//"UserGuide/section_1.html","S1D46");初始磨削接触位

	DEF GRIND_X=(R///$85132,$85132,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[40]"/360,60,110/460,60,60//);齿形平磨初始位x
	DEF GRIND_BUCHANG=(R///$85192,$85192,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[96]"/360,80,110/460,80,60//);通磨长度延长量

	DEF GRIND_A=(R///$85924,$85924,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[46]"/360,110,110/460,110,110//"UserGuide/section_1.html","S1D44");A轴磨削位
	DEF GRIND_B=(R///$85925,$85925,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[47]"/360,130,110/460,130,110//"UserGuide/section_1.html","S1D44");B轴磨削位
	DEF GRIND_SAFE=(R///$85172,$85172,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[48]"/360,150,202/460,150,60//"UserGuide/section_1.html","S1D13");磨削安全位置  ifIsExternal
