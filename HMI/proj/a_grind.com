...
//M(Mask3/$85077//);平磨参数
	...
	DEF GRIND_X=(R///$85132,$85132,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[40]"/360,110,110/460,110,60//);齿形平磨初始位x
	...
	DEF GRIND_BUCHANG_Z_QIAN=(R///$85947,$85947,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[136]"/360,190,110/460,190,60//);通磨长度补偿——前
	DEF GRIND_BUCHANG_Z_HOU=(R///$85948,$85948,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[96]"/360,210,110/460,210,60//);通磨长度补偿——后
	DEF GRIND_BUCHANG_X=(R///$85949,$85949,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[137]"/360,230,110/460,230,60//);通磨X向偏移
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF PIANZHUAN=(R///$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[110]"/360,340,120/460,340,110/);修整齿形偏转角度
