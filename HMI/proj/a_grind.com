...
//M(Mask3/$85077//);平磨参数
	...
	DEF SHALUN_JIZUN_HOUDU=(R///$85687,$85687,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[473]"/80,180,202/190,180,60/,"#fff4f1"/);通磨-自动计算起点.X-测头测量点所在砂轮位置距修整起点距离Z
	DEF POS_INPUT_AUTO_X_LABEL=(I///$85662,$85662,,/WR4///10,180,202/0,0,0/);坐标写入  圆拉刀-通磨槽
	DEF SHALUN_TOP_TO_SIDE=(R///$85758,$85758,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[387]"/80,180,202/190,180,60/,"#fff4f1"/);砂轮尖到修整起点距离Z  圆拉刀-通磨槽
	...
	CHANGE(POS_INPUT_AUTO_X)
		IF POS_INPUT_AUTO_X.VAL==1
			...
			IF XIUZHENG_MODE.VAL==1;插补
				IF SHALUN_CHOICE.VAL==0;砂轮1
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+CHABU_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+CHABU_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ELSE
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+CHABU_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+CHABU_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ENDIF
			ELSE
				IF SHALUN_CHOICE.VAL==0;砂轮1
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+CHENGXIN_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+CHENGXIN_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ELSE
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+CHENGXIN_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+CHENGXIN_SHALUN_HOUDU.VAL-SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ENDIF
	...
	SUB(UP1)
		IF LADAO_CHOICE.VAL==1
			IF GRIND_MODE.VAL==0;通磨槽
				...
				IF XIUZHENG_MODE.VAL==1;插补
					IF SHALUN_CHOICE.VAL==0;砂轮1
						GRIND_X_INIT.VAL=SHALUN1_90.VAL+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+CHABU_SHALUN_HOUDU.VAL-SHALUN_TOP_TO_SIDE.VAL
					ELSE
						GRIND_X_INIT.VAL=SHALUN2__90.VAL+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+CHABU_SHALUN_HOUDU.VAL-SHALUN_TOP_TO_SIDE.VAL
					ENDIF
				ELSE;成型
					IF SHALUN_CHOICE.VAL==0;砂轮1
						GRIND_X_INIT.VAL=SHALUN1_90.VAL+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+CHENGXIN_SHALUN_HOUDU.VAL-SHALUN_TOP_TO_SIDE.VAL
					ELSE
						GRIND_X_INIT.VAL=SHALUN2__90.VAL+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+CHENGXIN_SHALUN_HOUDU.VAL-SHALUN_TOP_TO_SIDE.VAL
					ENDIF
				ENDIF
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF POS_INPUT_AUTO_X=(I/*0=$85017,1=$85017/0/$85662,$85662,,/WR4///10,180,202/60,180,15/,"#0fb766");坐标写入键
	DEF SHALUN_JIZUN_HOUDU=(R///$85687,$85687,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[474]"/80,180,202/190,180,60/,"#fff4f1"/);通磨-自动计算起点.X-测头测量点所在砂轮位置距修整起点距离Z
	DEF POS_INPUT_AUTO_X_LABEL=(I///$85662,$85662,,/WR4///10,180,202/0,0,0/);坐标写入 
	DEF SHALUN_TOP_TO_SIDE=(R///$85758,$85758,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[475]"/80,180,202/190,180,60/,"#fff4f1"/);砂轮尖到修整起点Z  圆拉刀
	DEF MEAS_1ST_PIANYI_X=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[467]"/0,0,0/0,0,0//);测量第一齿齿侧面偏移距离.X
	DEF MEAS_1ST_VALUE_X=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[469]"/0,0,0/0,0,0//);测量第一齿齿侧面测量值.X
	DEF MEAS_TO_WHEEL_AXIS_DIS_1=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[384]"/0,0,0/0,0,0//);测量基准-测头距离砂轮一-轴向距离
	DEF MEAS_TO_WHEEL_AXIS_DIS_2=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[393]"/0,0,0/0,0,0//);测量基准-测头距离砂轮二-轴向距离
