...
//M(Mask51/$85025//)
	...
	DEF Y_QUIT=(R///$85106,$85106,,/WR2//"/NC/_N_NC_GD2_ACX/INI[24]"/360,10,202/460,10,60/,"#d3e8ff"/"UserGuide/section_1.html","S1D14");退刀位置Y
	DEF POS_INPUT_1=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,10,15/);坐标写入键

	DEF X_QUIT=(R///$85128,$85128,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[13]"/360,32,202/460,32,60/,"#d3e8ff"/"UserGuide/section_1.html","S1D14");退刀位置X
	DEF POS_INPUT_2=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,32,15/);坐标写入键

	DEF C_QUIT=(R/0,360//$85290,$85290,,/WR4,ac4//"/NC/_N_NC_GD2_ACX/INI[28]"/360,54,202/460,54,60/,"#d3e8ff"/);头架在程序结束调整到合适角度
...
//M(Mask1/$85075//);工件参数
	...
	DEF CIJU_AMOUNT=(R4///$85996,$85996,,$85043/WR1//"/NC/_N_NC_GD2_ACX/LADAO[370]"/190,30,110/270,30,110/);全长齿距

	DEF SLOT_INIT=(I/0,//$85904,$85904,,/WR2//"/NC/_N_NC_GD2_ACX/RING[3]"/190,60,110/270,60,60//"UserGuide/section_1.html","S1D43");起始磨削齿
	DEF SLOT_END=(I/0,//$85905,$85905,,/WR2//"/NC/_N_NC_GD2_ACX/RING[4]"/190,80,110/270,80,60//"UserGuide/section_1.html","S1D44");终止磨削齿

	;DEF INFO_MSG=(I///,$85986,,/WR4///10,150,110/0,0,0//);MSG
	DEF CAO_INIT=(I/0,//$85185,$85185,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[260]"/190,120,110/270,120,60//);起始磨削槽
	DEF CAO_END=(I/0,//$85186,$85186,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[261]"/190,140,110/270,140,60//);终止磨削槽
...
//M(Mask5/$85079//);顶刃磨削
	...
	DEF CISHENG_MODE=(I/*0=$85194,1=$85195//$85673,$85673,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[404]"/180,10,202/260,10,60/,"#ffc5c5"/);齿升量模式(0测量1标准)
...
//M(Mask3/$85077//);平磨参数
	...
	DEF GRIND_START=(R///$85129,$85129,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[41]"/360,10,110/460,10,60/,"#d3e8ff"/);平磨起点Z
	DEF POS_INPUT_1=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,10,15/);坐标写入键

	DEF GRIND_END=(R///$85294,$85294,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[283]"/360,30,110/460,30,60/,"#d3e8ff"/);平磨终点Z
	DEF POS_INPUT_9=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/530,30,15/);坐标写入键
	...
	DEF GRIND_ZUIDU=(R6///$85295,$85295,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[284]"/360,230,110/460,230,60/,"#fff4f1"/);平磨锥度
	...
	DEF BUCHANG_X_XISHU=(R///$85995,$85995,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[312]"/360,350,110/460,350,60/,"#e1ffe3"/);X轴向补偿系数
	...
	DEF CIJU_MODE=(I/*0=$85194,1=$85195//$85193,$85193,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[403]"/180,10,202/260,10,60/,"#ffc5c5"/);磨削齿距模式(0测量齿距/1标准齿距)
	...
	DEF Y_POSITION_CURR=(R///$85936,$85936,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND_RESULT[901]"/10,250,202/130,250,60//"UserGuide/section_1.html","S1D46");首齿当前磨削接触位Y
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF LENGTH_CI=(R///$85133,$85133,,/WR1//"/NC/_N_NC_GD2_ACX/LADAO[33]"/360,230,110/460,230,60/,"#fff4f1"/);齿厚
	...
	DEF GRIND_X_ANG=(R///$85995,$85995,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[217]"/360,350,110/460,350,60/,"#e1ffe3"/);铲背-X向补偿系数(当前齿总齿升量成系数就是当前齿x偏移量)
	...
	DEF CIJU_MODE=(I/*0=$85194,1=$85195//$85193,$85193,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[97]"/360,10,202/460,10,60/,"#ffc5c5"/);磨削齿距模式(0测量齿距/1标准齿距)
	DEF CISHENG_MODE=(I/*0=$85194,1=$85195//$85673,$85673,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[405]"/180,10,202/260,10,60/,"#ffc5c5"/);齿升量模式(0测量1标准)
...
//M(Mask8/$85086//);齿平面
	...
	DEF GRIND_POS=(I/*1=$85953,-1=$85954//$85952,$85952,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[152]"/360,10,202/460,10,60/,"#ffc5c5"/);齿平面磨-平面位置(1首齿/-1尾齿)
	...
	DEF WEICI_Z_BUCHANG_BIAOZUN=(R///$85997,$85997,,/WR1///10,280,202/130,280,60//);尾齿标准补偿.Z
	DEF WEICI_Z_BUCHANG_CELIANG=(R///$85998,$85998,,/WR1///10,300,202/130,300,60//);尾齿测量补偿.z
	DEF CISHENG_AMOUNT=(R4///$85971,$85971,,/WR1//"/NC/_N_NC_GD2_ACX/LADAO[73]"/10,320,110/130,320,60/);全长齿升量

	DEF Y_POSITION_CURR=(R///$85936,$85936,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[238]"/10,350,202/130,350,60//);当前磨削接触位Y
