...
//M(Mask4/$85078//);前刃磨削
	...
	DEF MO_CIBEI=(I/*0=$85190,1=$85191//$85098,$85098,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[348]"/180,30,202/250,30,60/,"#ffc5c5"/);前角-直接靠磨后背(0否1是) - 不可是斜线进刀，设置为1后侧面工艺界面三四工序为后背进刀
...
//M(Mask8/$85086//);齿平面
	...
	DEF MEASURE_POS_FRIST=(R////WR4//"/NC/_N_NC_GD2_ACX/MEASURE_RESULT[301]"/0,0,0/0,0,0/);第一齿前角测量位置.Z
	...
	LOAD
		...
		MEASURE_POS_LAST.VAR="/NC/_N_NC_GD2_ACX/MEASURE_RESULT["<<300+SLOT_AMOUNT.VAL<<"]"
