...
//M(Mask3/$85077//);平磨参数
	...
	CHANGE(POS_INPUT_AUTO_Y)
		IF POS_INPUT_AUTO_Y.VAL==1
			...
			IF SHALUN_CHOICE.VAL==0;砂轮1
				Y_POSITION_INIT.VAL=AUTO_1ST_Y.VAL-MEAS_GAN_LENGTH.VAL*COS(SRAD(MEAS_GAN_ANG.VAL))-MEAS_TO_WHEEL_HEIGTH_DIS_1.VAL+WHEEL_DIA.VAL/2+SHALUN_DIA_PIANYI.VAL
			ELSE
				Y_POSITION_INIT.VAL=AUTO_1ST_Y.VAL-MEAS_GAN_LENGTH.VAL*COS(SRAD(MEAS_GAN_ANG.VAL))-MEAS_TO_WHEEL_HEIGTH_DIS_2.VAL+WHEEL_DIA.VAL/2+SHALUN_DIA_PIANYI.VAL
			ENDIF
		ENDIF
	END_CHANGE
