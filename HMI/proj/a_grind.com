...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF Y_INIT_UP=(R/0,//$85198,$85198,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[206]"/360,80,202/460,80,110//);磨削起始Y偏置

	DEF GRIND_SAFE=(R/0,//$85172,$85172,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[70]"/360,100,202/460,100,110//"UserGuide/section_1.html","S1D13");安全抬高  ifIsExternal

	DEF GRIND_X_INIT=(R///$85968,$85968,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[72]"/360,130,110/460,130,60//);磨削起点x
	DEF POS_INPUT_3=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,130,18/);坐标写入键

	DEF GRIND_X_END=(R///$85969,$85969,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[218]"/360,150,110/460,150,60//);磨削终点x
