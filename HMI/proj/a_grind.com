...
//M(Mask5/$85079//);顶刃磨削
	...
	DEF CISHENG_MODE=(I/*0=$85262,1=$85215,2=$85195/2/$85673,$85673,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[404]"/180,10,202/260,10,60/,"#ffc5c5"/);后角-齿升量模式(0后角测量/1前角测量/2标准)
...
//M(Mask3/$85077//);平磨参数
	...
	DEF CIJU_MODE=(I/*0=$85194,1=$85195/1/$85193,$85193,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[403]"/360,10,202/460,10,60/,"#ffc5c5"/);磨削齿距模式(0测量齿距/1标准齿距)
	...
	DEF MO_ARC=(I/*0=$85274,1=$85275//$85273,$85273,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[458]"/180,30,202/260,30,80/,"#fff4f1"/);通磨-通磨槽-磨圆弧(0否/1是)
	DEF ARC_TYPE=(I/*0=$85277,1=$85278//$85276,$85276,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[459]"/180,50,202/260,50,80/,"#fff4f1"/);通磨-通磨槽-磨圆弧-圆弧类型(0凸圆弧 1凹圆弧)
	...
	DEF POS_INPUT_AUTO=(I/*0=$85017,1=$85017/0/$85675,$85675,,/WR2///10,140,202/120,140,15/,"#0fb766");坐标写入键
	...
	CHANGE(POS_INPUT_AUTO)
		IF POS_INPUT_AUTO.VAL==1
			POS_INPUT_AUTO.VAL=0
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF CIJU_MODE=(I/*0=$85194,1=$85195//$85193,$85193,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[97]"/360,10,202/460,10,60/,"#ffc5c5"/);磨削齿距模式(0测量齿距/1标准齿距)
	DEF CISHENG_MODE=(I/*0=$85262,1=$85215,2=$85195/2/$85673,$85673,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[405]"/180,10,202/260,10,60/,"#ffc5c5"/);铲背-齿升量模式(0后角测量/1前角测量/2标准)
