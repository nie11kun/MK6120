...
//M(Mask3/$85077//);平磨参数
	...
	DEF GRIND_START=(R///$85129,$85129,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[41]"/360,80,110/460,80,60//);平磨起点Z
	DEF Y_POSITION_INIT=(R///$85935,$85935,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[235]"/360,100,202/460,100,60//"UserGuide/section_1.html","S1D46");初始磨削接触位
	DEF Y_POSITION_CURR=(R///$85936,$85936,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[237]"/360,120,202/460,120,60//"UserGuide/section_1.html","S1D46");当前磨削接触位
	...
	DEF GRIND_X=(R///$85132,$85132,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[40]"/360,180,110/460,180,60//);齿形平磨初始位x
	DEF GRIND_BUCHANG=(R///$85192,$85192,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[96]"/360,200,110/460,200,60//);通磨长度延长量

	DEF GRIND_A=(R///$85924,$85924,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[46]"/360,230,110/460,230,110//"UserGuide/section_1.html","S1D44");A轴磨削位
	DEF GRIND_B=(R///$85925,$85925,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[47]"/360,250,110/460,250,110//"UserGuide/section_1.html","S1D44");B轴磨削位
