...
//M(Mask3/$85077//);平磨参数
	...
	DEF POS_INPUT_AUTO_Z=(I/*0=$85017,1=$85017/0/$85675,$85675,,/WR2///10,140,202/120,140,15/,"#0fb766");坐标写入键
	...
	DEF POS_INPUT_AUTO_X=(I/*0=$85017,1=$85017/0/$85662,$85662,,/WR4///10,160,202/120,160,15/,"#0fb766");坐标写入键
	DEF SHALUN_JIZUN_HOUDU=(R///$85687,$85687,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[473]"/10,180,202/120,180,60/,"#fff4f1"/);通磨-自动计算起点.X-砂轮基准宽度
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF POS_INPUT_AUTO_X=(I/*0=$85017,1=$85017/0/$85662,$85662,,/WR4///10,160,202/120,160,15/,"#0fb766");坐标写入键
	DEF SHALUN_JIZUN_HOUDU=(R///$85687,$85687,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[474]"/10,180,202/120,180,60/,"#fff4f1"/);通磨-自动计算起点.X-砂轮基准宽度
	DEF MEAS_1ST_PIANYI_X=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[467]"/0,0,0/0,0,0//);测量第一齿齿侧面偏移距离.X
	DEF MEAS_1ST_VALUE_X=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[469]"/0,0,0/0,0,0//);测量第一齿齿侧面测量值.X
	DEF MEAS_TO_WHEEL_AXIS_DIS_1=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[384]"/0,0,0/0,0,0//);测量基准-测头距离砂轮一-轴向距离
	DEF MEAS_TO_WHEEL_AXIS_DIS_2=(R////WR4//"/NC/_N_NC_GD2_ACX/LADAO[393]"/0,0,0/0,0,0//);测量基准-测头距离砂轮二-轴向距离
