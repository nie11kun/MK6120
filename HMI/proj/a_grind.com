	...
	CHANGE(POS_INPUT_AUTO_X)
		IF POS_INPUT_AUTO_X.VAL==1
			...
			IF XIUZHENG_MODE.VAL==1;插补
				IF SHALUN_CHOICE.VAL==0;砂轮1
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ELSE
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHABU_MOGAN_LENGTH.VAL+CHABU_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ENDIF
			ELSE
				IF SHALUN_CHOICE.VAL==0;砂轮1
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_1.VAL+MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ELSE
					IF MEAS_1ST_PIANYI_X.VAL>0
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL-MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ELSE
						GRIND_X_INIT.VAL=MEAS_1ST_VALUE_X.VAL+MEAS_RAD.VAL+MEAS_TO_WHEEL_AXIS_DIS_2.VAL-MEAS_GAN_LENGTH.VAL*SIN(SRAD(MEAS_GAN_ANG.VAL))+CHENGXIN_MOGAN_LENGTH.VAL+CHENGXIN_MOGAN_DIANQUAN_HOUDU.VAL+SHALUN_JIZUN_HOUDU.VAL
					ENDIF
				ENDIF
