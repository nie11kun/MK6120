...
//M(Mask5/$85079//);顶刃磨削
	...
	DEF CISHENG_MODE=(I/*0=$85262,1=$85215,2=$85195/2/$85673,$85673,,/WR1//"/NC/_N_NC_GD2_ACX/LADAO[404]"/180,10,202/260,10,60/,"#ffc5c5"/);后角-齿升量模式(0后角测量/1前角测量/2标准)
...
//M(Mask3/$85077//);平磨参数
	...
	DEF CIJU_MODE=(I/*0=$85194,1=$85195/1/$85193,$85193,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[403]"/180,10,202/260,10,60/,"#ffc5c5"/);磨削齿距模式(0测量齿距/1标准齿距)
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF CIJU_MODE=(I/*0=$85194,1=$85195//$85193,$85193,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[97]"/360,10,202/460,10,60/,"#ffc5c5"/);磨削齿距模式(0测量齿距/1标准齿距)
	DEF CISHENG_MODE=(I/*0=$85262,1=$85215,2=$85195/2/$85673,$85673,,/WR1//"/NC/_N_NC_GD2_ACX/LADAO[405]"/180,10,202/260,10,60/,"#ffc5c5"/);铲背-齿升量模式(0后角测量/1前角测量/2标准)
