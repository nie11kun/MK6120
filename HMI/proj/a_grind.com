...
//M(Mask51/$85025//)
	...
	DEF GRIND_CHOICE=(I/*0=$85078,1=$85077,2=$85079,3=$85081,4=$85080,5=$85086//$85131,$85131,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[38]"/360,10,202/460,10,80/);加工选择(0前刃、1齿形平磨，2齿顶后刃，3齿侧后刃)
...
//M(Mask4/$85078//);前刃磨削
	...
	DEF PIANZHUAN=(R/0,90//$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[8]"/360,320,120/460,320,110/);修整齿形偏转角度
	...
	DEF AUTO_CALC=(I/*0=$85013,1=$85014//$85939,$85939,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[44]"/10,310,120/130,310,30//"UserGuide/section_1.html","S1D19");新砂轮修整后校准磨削位
	DEF Z_POSITION_ACT=(R///$85940,$85940,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[45]"/10,330,202/130,330,60//"UserGuide/section_1.html","S1D45");实际首齿当前.Z
	DEF Y_POSITION_ACT=(R///$85941,$85941,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[46]"/10,350,202/130,350,60//"UserGuide/section_1.html","S1D46");实际首齿当前.Y
...
//M(Mask6/$85080//);后背磨削
	...
	DEF PIANZHUAN=(R/0,90//$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[15]"/360,320,120/460,320,110/);修整齿形偏转角度
	...
	DEF AUTO_CALC=(I/*0=$85013,1=$85014//$85939,$85939,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[138]"/10,310,120/130,310,30//"UserGuide/section_1.html","S1D19");新砂轮修整后校准磨削位
	DEF Z_POSITION_ACT=(R///$85940,$85940,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[139]"/10,330,202/130,330,60//"UserGuide/section_1.html","S1D45");实际首齿当前.Z
	DEF Y_POSITION_ACT=(R///$85941,$85941,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[140]"/10,350,202/130,350,60//"UserGuide/section_1.html","S1D46");实际首齿当前.Y
...
//M(Mask5/$85079//);顶刃磨削
	...
	DEF PIANZHUAN=(R/0,90//$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[108]"/360,320,120/460,320,110/);修整齿形偏转角度
	...
	DEF AUTO_CALC=(I/*0=$85013,1=$85014//$85939,$85939,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[58]"/10,310,120/130,310,30//"UserGuide/section_1.html","S1D19");新砂轮修整后校准磨削位
	DEF Z_POSITION_ACT=(R///$85940,$85940,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[59]"/10,330,202/130,330,60//"UserGuide/section_1.html","S1D45");实际首齿当前.Z
	DEF Y_POSITION_ACT=(R///$85941,$85941,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[60]"/10,350,202/130,350,60//"UserGuide/section_1.html","S1D46");实际首齿当前.Y
...
//M(Mask3/$85077//);平磨参数
	...
	DEF GRIND_A=(R///$85924,$85924,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[46]"/360,120,110/460,120,110//"UserGuide/section_1.html","S1D44");A轴磨削位
	DEF GRIND_B=(R///$85925,$85925,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[47]"/360,140,110/460,140,110//"UserGuide/section_1.html","S1D44");B轴磨削位

	DEF GRIND_BUCHANG_Z_QIAN=(R///$85947,$85947,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[136]"/360,170,110/460,170,60//);通磨长度补偿——前
	DEF GRIND_BUCHANG_Z_HOU=(R///$85948,$85948,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[96]"/360,190,110/460,190,60//);通磨长度补偿——后
	DEF GRIND_BUCHANG_X=(R///$85949,$85949,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[137]"/360,210,110/460,210,60//);通磨X向偏移

	DEF PIANZHUAN=(R/0,90//$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[109]"/360,320,120/460,320,110/);修整齿形偏转角度
	...
	DEF Y_POSITION_CURR=(R///$85936,$85936,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[237]"/10,280,202/130,280,60//"UserGuide/section_1.html","S1D46");当前磨削接触位Y

	DEF AUTO_CALC=(I/*0=$85013,1=$85014//$85939,$85939,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[18]"/10,310,120/130,310,30//"UserGuide/section_1.html","S1D19");新砂轮修整后校准磨削位
	DEF Z_POSITION_ACT=(R///$85943,$85943,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[19]"/10,330,202/130,330,60//"UserGuide/section_1.html","S1D45");实际首齿当前.Z
	DEF Y_POSITION_ACT=(R///$85944,$85944,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[20]"/10,350,202/130,350,60//"UserGuide/section_1.html","S1D46");实际首齿当前.Y
...
//M(Mask7/$85081//);顶部侧刃
	...
	DEF LENGTH_CI=(R///$85133,$85133,,/WR1//"/NC/_N_NC_GD2_ACX/LADAO[33]"/360,230,110/460,230,60//);齿厚
	DEF GRIND_BUCHANG_Z_QIAN=(R///$85950,$85950,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[138]"/360,250,110/460,250,60//);长度补偿——前
	DEF GRIND_BUCHANG_Z_HOU=(R///$85951,$85951,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[139]"/360,270,110/460,270,60//);长度补偿——后
	DEF GRIND_BUCHANG_X=(R///$85949,$85949,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[140]"/360,290,110/460,290,60//);X向偏移

	DEF PIANZHUAN=(R/0,90//$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[110]"/360,320,120/460,320,110/);修整齿形偏转角度
	...
	DEF AUTO_CALC=(I/*0=$85013,1=$85014//$85939,$85939,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[98]"/10,310,120/130,310,30//"UserGuide/section_1.html","S1D19");新砂轮修整后校准磨削位
	DEF Z_POSITION_ACT=(R///$85940,$85940,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[99]"/10,330,202/130,330,60//"UserGuide/section_1.html","S1D45");实际首齿当前.Z
	DEF Y_POSITION_ACT=(R///$85941,$85941,,/WR2//"/NC/_N_NC_GD2_ACX/TECH_ADDED[100]"/10,350,202/130,350,60//"UserGuide/section_1.html","S1D46");实际首齿当前.Y
...
//M(Mask8/$85086//);齿平面
	...
	DEF GRIND_START=(R///$85177,$85177,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[141]"/360,40,110/460,40,60//);起点Z
	DEF Y_POSITION_INIT=(R///$85935,$85935,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[146]"/360,60,202/460,60,60/);初始磨削接触位

	DEF GRIND_SAFE=(R///$85172,$85172,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[145]"/360,90,202/460,90,60//);磨削安全位置  ifIsExternal

	DEF GRIND_X_START=(R///$85922,$85922,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[143]"/360,120,110/460,120,60//);齿形初始位x
	DEF GRIND_X_END=(R///$85923,$85923,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[144]"/360,140,110/460,140,60//);齿形磨削终点.X
	...
	DEF PIANZHUAN=(R/0,90//$85477,$85477,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[150]"/360,320,120/460,320,110/);修整齿形偏转角度
