...
//M(Mask1/$85085//)
	...
	HS6=(["\\S_007.png",$85085],ac7,se3,pa0);
...
//G(Measure_1/0/51)
	...
	(R///$85678,$85678/WR3//"MEASURE_RESULT[2100]"/80/1);底面累计偏移Y
	(R///$85579,$85579/WR3//"MEASURE_RESULT[1050]"/80/1);顶刃偏移Y
	(R///$85674,$85674/WR3//"MEASURE_RESULT[1950]"/80/1);顶刃累计偏移Y
	...
	(R4///$85514,$85514/WR3//"MEASURE_RESULT[2250]"/80/1);齿轮分度误差
//END
...
//G(Measure_2/0/51)
	...
	(R///$85678,$85678/WR3//"MEASURE_RESULT[2150]"/80/1);底面累计偏移Y
	(R///$85579,$85579/WR3//"MEASURE_RESULT[1100]"/80/1);顶刃偏移Y
	(R///$85674,$85674/WR3//"MEASURE_RESULT[2000]"/80/1);顶刃累计偏移Y
	...
	(R4///$85514,$85514/WR3//"MEASURE_RESULT[2300]"/80/1);齿轮分度误差
//END
...
//G(Measure_3/0/51)
	...
	(R///$85678,$85678/WR3//"MEASURE_RESULT[2200]"/80/1);底面累计偏移Y
	(R///$85579,$85579/WR3//"MEASURE_RESULT[1150]"/80/1);顶刃偏移Y
	(R///$85674,$85674/WR3//"MEASURE_RESULT[2050]"/80/1);顶刃累计偏移Y
	...
	(R4///$85514,$85514/WR3//"MEASURE_RESULT[2350]"/80/1);齿轮分度误差
//END
