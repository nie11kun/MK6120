...
//M(Mask21/$85026//)
	...
	DEF VAR7=(I///$85577,$85577,,/WR1//"/NC/_N_NC_GD2_ACX/LADAO[28]"/20,30,150/140,30,60//);自动测量当前测量齿槽
	...
	DEF VAR0=(R///$85570,$85570,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[21]"/320,40,150/440,40,110//);自动测量起始X位置
	DEF VAR1=(R///$85571,$85571,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[22]"/320,60,150/440,60,110//);自动测量起始Y位置
	DEF VAR2=(R///$85572,$85572,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[23]"/320,80,150/440,80,110//);自动测量起始Z位置
	DEF VAR3=(R///$85573,$85573,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[24]"/320,100,150/440,100,110//);自动测量起始A位置
	DEF VAR4=(R///$85574,$85574,,$85042/WR2//"/NC/_N_NC_GD2_ACX/LADAO[25]"/320,120,150/440,120,110//);自动测量起始B位置

	DEF VAR6=(R///$85582,$85582,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[37]"/320,150,150/440,150,110//);测头半径

	DEF VAR5=(R///$85575,$85575,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[26]"/320,180,150/440,180,110//);自动测量Y轴前刃测量位
	DEF VAR8=(R///$85580,$85580,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[29]"/320,200,150/440,200,110//);自动测量底面相对前刃距离Z
	DEF VAR9=(R///$85581,$85581,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[30]"/320,220,150/440,220,110//);自动测量顶面相对前刃距离Z
