...
//M(Mask21/$85026//)
	...
	DEF MEAS_1ST_VALUE=(R///$85682,$85682,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[469]"/10,280,202/130,280,60/"#5ded67"/);测量第一齿齿侧面测量值.X
	...
	DEF MEAS_BASE_1=(R///$85691,$85694,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[476]"/10,310,220/130,310,60/"#5ded67",129/);自动计算磨削位_实际测量-测头相对回转中心虚拟半径
	DEF MEAS_BASE_2=(R///$85692,$85695,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[477]"/10,330,220/130,330,60/"#5ded67",129/);自动计算磨削位_实际测量-测头虚拟半径和测量杆的夹角
	DEF MEAS_BASE_3=(R///$85693,$85696,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[478]"/10,350,220/130,350,60/"#5ded67",129/);自动计算磨削位_实际测量-测头测量时虚拟半径垂直向下的夹角
