...
//M(Mask21/$85026//)
	...
	DEF VAR9=(R///$85581,$85581,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[30]"/320,300,150/440,300,110/,"#e1ffe3"/);自动测量顶面相对前刃距离Z
	DEF LAST_BEI=(R/0,//$85557,$85557,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[184]"/290,320,200/440,320,110/,"#e1ffe3"/);最后一个齿背底面测量偏置.Z

	DEF CETOU_POS_REFINE=(I/*0=$85190,1=$85191//$85504,$85504,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[481]"/170,10,202/240,10,60/,"#ffc5c5"/);测头实际位置校准(0否1是)

	DEF AUTO_CHOICE=(I/*0=$85595,1=$85596,2=$85597,3=$85672,4=$85677//$85594,$85594,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[94]"/320,10,202/400,10,80/,"#ffc5c5");自动测量-测量位置(0全测/1前刃)
	DEF AUTO_CI_NUM=(I/*0=$85502,1=$85503//$85501,$85501,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[337]"/0,0,0/490,10,60/,"#ffc5c5");自动对刀-测量齿数量(0全测  1测第一齿)

	DEF MEAS_1ST_SIDE=(I/*0=$85190,1=$85191//$85679,$85679,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[466]"/10,140,202/130,140,60/,"#ffc5c5"/);自动对刀-是否测量第一齿齿侧面(0否1是) -- 用来计算通磨起始
	DEF MEAS_1ST_SAFE_Y=(R///$85699,$85699,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[49]"/10,160,202/130,160,60/,"#d3e8ff"/);自动对刀-测量基准XY时安全位.Y
	DEF POS_INPUT_14=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,160,15/);坐标写入键
	DEF MEAS_1ST_DIRECTION=(I/*1=$85609,-1=$85610//$85608,$85608,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[336]"/10,180,202/130,180,60/,"#ffc5c5"/);自动对刀-测量第一齿齿侧面测量方向.X(1正向 -1负向)
	DEF MEAS_1ST_PIANYI_X=(R///$85680,$85680,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[467]"/10,200,202/130,200,60/,"#d3e8ff"/);测量第一齿齿侧面.X
	DEF POS_INPUT_8=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,200,15/);坐标写入键
	DEF MEAS_1ST_PIANYI_Y=(R///$85681,$85681,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[468]"/10,220,202/130,220,60/,"#d3e8ff"/);测量第一齿齿侧面.Y
	DEF POS_INPUT_9=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,220,15/);坐标写入键
	DEF MEAS_1ST_PIANYI_Z=(R///$85686,$85686,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[470]"/10,240,202/130,240,60/,"#d3e8ff"/);测量第一齿齿侧面.Z
	DEF POS_INPUT_10=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,240,15/);坐标写入键
	DEF MEAS_1ST_ANG=(R/0,90//$85515,$85515,,$85042/WR4//"/NC/_N_NC_GD2_ACX/LADAO[490]"/10,260,202/130,260,110/,"#fff4f1"/);自动对刀-测量第一齿齿侧-测量角度(0度测量垂直面  非0则为测量标准棒)
	DEF MEAS_1ST_LB_DIA=(R/0,//$85516,$85516,,$85043/WR4//"/NC/_N_NC_GD2_ACX/LADAO[491]"/10,280,202/130,280,110/,"#fff4f1"/);自动对刀-测量第一齿齿侧-测量标准棒直径
	DEF MEAS_1ST_DING_ENABLE=(I/*0=$85190,1=$85191//$85524,$85524,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[48]"/10,280,202/130,280,60/,"#ffc5c5"/);自动对刀-是否探测基准Y(0否1是)
	DEF MEAS_1ST_DING_X=(R///$85517,$85517,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[494]"/10,300,202/130,300,60/,"#d3e8ff"/);测量第一齿顶面测量.X
	DEF POS_INPUT_11=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,300,15/);坐标写入键
	DEF MEAS_1ST_DING_Y=(R///$85518,$85518,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[495]"/10,320,202/130,320,60/,"#d3e8ff"/);测量第一齿顶面测量.Y
	DEF POS_INPUT_12=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,320,15/);坐标写入键
	DEF MEAS_1ST_DING_Z=(R///$85519,$85519,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[496]"/10,340,202/130,340,60/,"#d3e8ff"/);测量第一齿顶面测量.Z
...
//M(Mask50/$85504//)
	...
	DEF VAR0=(R///$85508,$85508,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[486]"/320,10,150/440,10,60/,"#d3e8ff"/);自动测量起始X位置
	DEF POS_INPUT_0=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,10,15/);坐标写入键
	DEF VAR1=(R///$85509,$85509,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[487]"/320,30,150/440,30,60/,"#d3e8ff"/);自动测量Y轴前刃测量位
	DEF POS_INPUT_1=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,30,15/);坐标写入键
	DEF VAR2=(R///$85510,$85510,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[488]"/320,50,150/440,50,60/,"#d3e8ff"/);自动测量起始Z位置
	DEF POS_INPUT_2=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR2///0,0,0/530,50,15/);坐标写入键

	DEF VAR3=(R/0,//$85511,$85511,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[485]"/320,80,150/440,80,110/,"#fff4f1"/);测头半径
	DEF GAN_LENGTH=(R/0,//$85512,$85512,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[489]"/320,100,150/440,100,110/,"#fff4f1"/);测量杆总长

	DEF VAR4=(R///$85505,$85505,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[482]"/320,130,150/440,130,60/,"#d3e8ff"/);基准测头球中心相对-砂轮回转中心.X
	DEF VAR5=(R///$85506,$85506,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[483]"/320,150,150/440,150,60/,"#d3e8ff"/);基准测头球中心相对-砂轮回转中心.Y
	DEF VAR6=(R///$85507,$85507,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[484]"/320,170,150/440,170,60/,"#d3e8ff"/);基准测量杆为0时相对-砂轮回转中心.Z
