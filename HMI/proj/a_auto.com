...
//M(Mask21/$85026//)
	...
	DEF MEAS_1ST_DIRECTION=(I/*1=$85609,-1=$85610//$85608,$85608,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[336]"/10,160,202/130,160,60/,"#ffc5c5"/);自动对刀-测量第一齿齿侧面测量方向.X(1正向 -1负向)
	DEF MEAS_1ST_PIANYI_X=(R///$85680,$85680,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[467]"/10,180,202/130,180,60/,"#d3e8ff"/);测量第一齿齿侧面.X
	DEF POS_INPUT_8=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,180,15/);坐标写入键
	DEF MEAS_1ST_PIANYI_Y=(R///$85681,$85681,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[468]"/10,200,202/130,200,60/,"#d3e8ff"/);测量第一齿齿侧面.Y
	DEF POS_INPUT_9=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,200,15/);坐标写入键
	DEF MEAS_1ST_PIANYI_Z=(R///$85686,$85686,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[470]"/10,220,202/130,220,60/,"#d3e8ff"/);测量第一齿齿侧面.Z
	DEF POS_INPUT_10=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,220,15/);坐标写入键
	DEF MEAS_1ST_ANG=(R/0,90//$85515,$85515,,$85042/WR4//"/NC/_N_NC_GD2_ACX/LADAO[490]"/10,240,202/130,240,110/,"#fff4f1"/);自动对刀-测量第一齿齿侧-测量角度(0度测量垂直面  非0则为测量标准棒)
	DEF MEAS_1ST_LB_DIA=(R/0,//$85516,$85516,,$85043/WR4//"/NC/_N_NC_GD2_ACX/LADAO[491]"/10,260,202/130,260,110/,"#fff4f1"/);自动对刀-测量第一齿齿侧-测量标准棒直径
	DEF MEAS_1ST_DING_ENABLE=(I/*0=$85190,1=$85191//$85524,$85524,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[48]"/10,260,202/130,260,60/,"#ffc5c5"/);自动对刀-是否探测基准Y(0否1是)
	DEF MEAS_1ST_DING_X=(R///$85517,$85517,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[494]"/10,280,202/130,280,60/,"#d3e8ff"/);测量第一齿顶面测量.X
	DEF POS_INPUT_11=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,280,15/);坐标写入键
	DEF MEAS_1ST_DING_Y=(R///$85518,$85518,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[495]"/10,300,202/130,300,60/,"#d3e8ff"/);测量第一齿顶面测量.Y
	DEF POS_INPUT_12=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,300,15/);坐标写入键
	DEF MEAS_1ST_DING_Z=(R///$85519,$85519,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[496]"/10,320,202/130,320,60/,"#d3e8ff"/);测量第一齿顶面测量.Z
	DEF POS_INPUT_13=(I/*0=$85017,1=$85017/0/$85058,$85058,,/WR4///0,0,0/200,320,15/);坐标写入键
