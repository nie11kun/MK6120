...
//M(Mask21/$85026//)
	...
	DEF MEAS_BASE_1=(R///$85691,$85694,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[476]"/10,260,220/130,260,60/"#5ded67"/);自动计算磨削位_实际测量-测头相对回转中心虚拟半径
	DEF MEAS_BASE_2=(R///$85692,$85695,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[477]"/10,280,220/130,280,60/"#5ded67"/);自动计算磨削位_实际测量-测头虚拟半径和偏移距离长度的夹角
	DEF MEAS_BASE_3=(R///$85693,$85696,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[478]"/10,300,220/130,300,60/"#5ded67"/);自动计算磨削位_实际测量-测头测量时虚拟半径垂直向下的夹角
