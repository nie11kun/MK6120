...
//M(Mask21/$85026//)
	...
	DEF MEAS_1ST_PIANYI_X=(R///$85680,$85680,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[467]"/10,160,202/130,160,60/,"#e1ffe3"/);测量第一齿齿侧面偏移距离.X
	DEF MEAS_1ST_PIANYI_Y=(R///$85681,$85681,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[468]"/10,180,202/130,180,60/,"#e1ffe3"/);测量第一齿齿侧面偏移距离.Y
	DEF MEAS_1ST_PIANYI_Z=(R///$85686,$85686,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[470]"/10,200,202/130,200,60/,"#e1ffe3"/);测量第一齿齿侧面偏移距离.Z
	DEF MEAS_1ST_VALUE=(R///$85682,$85682,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[469]"/10,220,202/130,220,60/"#5ded67"/);测量第一齿齿侧面测量值.X

	DEF MEAS_FENGDU=(I/*0=$85190,1=$85738,2=$85739//$85697,$85697,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[324]"/10,160,202/130,160,70/,"#ffc5c5"/);自动测量-是否测量齿轮齿槽精度(0否1是)
	...
	DEF MEAS_BASE_1=(R///$85691,$85694,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[476]"/10,260,220/130,260,60/"#5ded67",129/);自动计算磨削位_实际测量-测头相对回转中心虚拟半径
	DEF MEAS_BASE_2=(R///$85692,$85695,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[477]"/10,280,220/130,280,60/"#5ded67",129/);自动计算磨削位_实际测量-测头虚拟半径和测量杆的夹角
	DEF MEAS_BASE_3=(R///$85693,$85696,,/WR3//"/NC/_N_NC_GD2_ACX/LADAO[478]"/10,300,220/130,300,60/"#5ded67",129/);自动计算磨削位_实际测量-测头测量时虚拟半径垂直向下的夹角
