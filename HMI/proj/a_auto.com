...
//M(Mask21/$85026//)
	...
	DEF VAR10=(R///$85587,$85587,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[27]"/20,70,150/140,70,110//);自动测量前刃相对底面距离Y
	DEF VAR8=(R///$85580,$85580,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[29]"/20,90,150/140,90,110//);自动测量底面相对前刃距离Z
	DEF VAR9=(R///$85581,$85581,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[30]"/20,110,150/140,110,110//);自动测量顶面相对前刃距离Z
	DEF VAR6=(R///$85582,$85582,,$85043/WR2//"/NC/_N_NC_GD2_ACX/LADAO[37]"/20,130,150/140,130,110//);测头半径
...
//G(Measure/0/51)
	...
	(R///$85578,$85578/WR3//"MEASURE_RESULT[300]"/80/1)
	(R///$85579,$85579/WR3//"MEASURE_RESULT[350]"/80/1)
	(R///$85564,$85564/WR3//"MEASURE_RESULT[0]"/80/1)
	(R///$85565,$85565/WR3//"MEASURE_RESULT[50]"/80/1)
	(R///$85566,$85566/WR3//"MEASURE_RESULT[100]"/80/1)
	(R///$85567,$85567/WR3//"MEASURE_RESULT[150]"/80/1)
	(R///$85568,$85568/WR3//"MEASURE_RESULT[200]"/80/1)
	(R///$85569,$85569/WR3//"MEASURE_RESULT[250]"/80/1)
//END
