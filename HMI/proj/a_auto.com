...
//M(Mask21/$85026//)
	...
	DEF MEAS_1ST_SIDE=(I/*0=$85190,1=$85191//$85679,$85679,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[466]"/10,190,202/130,190,60/,"#ffc5c5"/);自动对刀-是否测量第一齿齿侧面(0否1是) -- 用来计算通磨起始X
	DEF MEAS_1ST_PIANYI_X=(R///$85680,$85680,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[467]"/10,210,202/130,210,60/,"#e1ffe3"/);测量第一齿齿侧面偏移距离.X
	DEF MEAS_1ST_PIANYI_Y=(R///$85681,$85681,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[468]"/10,230,202/130,230,60/,"#e1ffe3"/);测量第一齿齿侧面偏移距离.Y
	DEF MEAS_1ST_PIANYI_Z=(R///$85686,$85686,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[470]"/10,250,202/130,250,60/,"#e1ffe3"/);测量第一齿齿侧面偏移距离.Z
	DEF MEAS_1ST_VALUE=(R///$85682,$85682,,/WR4//"/NC/_N_NC_GD2_ACX/LADAO[469]"/10,270,202/130,270,60/"#5ded67"/);测量第一齿齿侧面测量值.X
