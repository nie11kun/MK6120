//M(Mask1/$85076//);加工数据
	...
	HS5=(["\\S_008.png",$85076],ac7,se3,pa0);加工数据
...
//G(POSITION_CURR_1/0/51)
	...
	(R///$85493,$85493/WR3//"GRIND_RESULT[900]"/80/1);通磨当前接触Y1
//END
...
//G(POSITION_CURR_2/0/51)
	...
	(R///$85493,$85493/WR3//"GRIND_RESULT[950]"/80/1);通磨当前接触Y1
//END
...
//G(POSITION_CURR_3/0/51)
	...
	(R///$85493,$85493/WR3//"GRIND_RESULT[1000]"/80/1);通磨当前接触Y1
//END
