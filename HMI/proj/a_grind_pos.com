//M(Mask1/$85076//);加工数据
	...
	DEF GRID={TYP="R",TGL="% POSITION_CURR_1",X=10,W=540,H=330};
...
//M(Mask2/$85076//);加工数据
	...
	DEF GRID={TYP="R",TGL="% POSITION_CURR_2",X=10,W=540,H=330};
...
//M(Mask3/$85076//);加工数据
	...
	DEF GRID={TYP="R",TGL="% POSITION_CURR_3",X=10,W=540,H=330};
