//M(Mask1/$85037//);历史记录
	...
	DEF CUR_SHAPE=(I/0,50//$85038,$85038,,/WR2//"/NC/_N_NC_GD2_ACX/CUR_SHAPE"/10,10,110/120,10,60//"UserGuide/section_34.html","S34D01");当前行号
	DEF RESTORE_LINE=(I/0,50//$85030,$85030,,/WR2//"/NC/_N_NC_GD2_ACX/LADAO[500]"/360,10,110/470,10,60//"UserGuide/section_34.html","S34D02");历史记录恢复行号
	DEF RESTORE_WORKPAR=(I//0//WR4//"/NC/_N_NC_GD2_ACX/LADAO[505]"/0,0,0/0,0,0//);恢复工件数据(0否1是)

	DEF RESTORE_COMFIRM=(I//0//WR4,ac4///0,0,0/0,0,0/);参数恢复判断参数
	DEF RESTORE_PAR_COMFIRM=(I//0//WR4,ac4///0,0,0/0,0,0/);参数恢复工件参数判断参数
	...
	DEF CURR_PROCESS_NO=(R////WR4///0,0,0/0,0,0//);恢复行加工选择
	...
	DEF GRIND_CHOICE=(I////WR4//"/NC/_N_NC_GD2_ACX/LADAO[38]"/0,0,0/0,0,0//);加工选择(0前刃、1齿形平磨，2齿顶后刃，3齿侧后刃)
	...
	PRESS(VS2)
		RESTORE_WORKPAR.VAL=1
		LM("Mask2","a_dress_data.com",1,RESTORE_PAR_COMFIRM)
		RESTORE_WORKPAR.VAL=0
	END_PRESS
	...
	SUB(UP1)
		...
		CURR_PROCESS_NO.VAR="HISTORY_PROCESS_NO["<< RESTORE_LINE.VAL <<"]"
		...
		ENDIF
		GRIND_CHOICE.VAL=CURR_PROCESS_NO.VAL
...
//M(Mask2/$85037//)
	...
	DEF MSG=(I///$85032,$85032,,/WR1,ac4///120,170,320/0,0,0/,,"#000000");
	DEF TITLE=(I///$85033,$85033,,/WR1,ac4///250,120,220/0,0,0/,,"#ffffff");
	DEF RESTORE_WORKPAR=(I////WR4//"/NC/_N_NC_GD2_ACX/LADAO[505]"/0,0,0/0,0,0//);恢复工件数据(0否1是)
...
//G(SHAPE_CURR_1/0/51)
	...
	(S///$85131,$85131/WR2//"HISTORY_PROCESS_STR[1]"/80/1);加工选择
