...
|LADAO[313]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_长度(磨杆1需要长于磨杆2)
|LADAO[314]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_直径
|LADAO[315]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴0度_向左接触坐标_Z
|LADAO[316]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴0度_向下接触坐标_Y
|LADAO[317]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴90度_向左接触坐标_Z
|LADAO[318]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴90度_向下接触坐标_Y
|LADAO[319]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_长度
|LADAO[320]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_直径
|LADAO[321]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴0度_向左接触坐标_Z
|LADAO[322]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴0度_向下接触坐标_Y
|LADAO[323]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴90度_向左接触坐标_Z
|LADAO[324]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴90度_向下接触坐标_Y
|LADAO[325]||自动计算磨削位_校准数据-砂轮1-基准长度(磨杆长度为0时)
|LADAO[326]||自动计算磨削位_校准数据-砂轮1-中心偏移(磨杆距离回转中心偏移)
|LADAO[327]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_长度(磨杆1需要长于磨杆2)
|LADAO[328]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_直径
|LADAO[329]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴0度_向左接触坐标_Z
|LADAO[330]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴0度_向下接触坐标_Y
|LADAO[331]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴90度_向左接触坐标_Z
|LADAO[332]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴90度_向下接触坐标_Y
|LADAO[333]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_长度
|LADAO[334]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_直径
|LADAO[335]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴0度_向左接触坐标_Z
|LADAO[336]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴0度_向下接触坐标_Y
|LADAO[337]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴90度_向左接触坐标_Z
|LADAO[338]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴90度_向下接触坐标_Y
|LADAO[339]||自动计算磨削位_校准数据-砂轮2-基准长度(磨杆长度为0时)
|LADAO[340]||自动计算磨削位_校准数据-砂轮2-中心偏移(磨杆距离回转中心的偏移距离)
|LADAO[341]||自动计算磨削位_校准数据-测头1-测头总长度(包括前端球)(测头1需长于测头2)
|LADAO[342]||自动计算磨削位_校准数据-测头1-测头测量球半径
|LADAO[343]||自动计算磨削位_校准数据-A轴测量角度1(大于零的一个角度)
|LADAO[344]||自动计算磨削位_校准数据-A轴测量角度2(大于角度1的一个角度)
|LADAO[345]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_向右接触坐标_Z
|LADAO[346]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_向下接触坐标_Y
|LADAO[347]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度2_向右接触坐标_Z
|LADAO[348]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度2_向下接触坐标_Y
|LADAO[349]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_测头收回去一定距离_向右接触坐标_Z
|LADAO[350]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_测头收回去一定距离_向下接触坐标_Y
|LADAO[351]||自动计算磨削位_校准数据-测头2-测头总长度(包括前端球)
|LADAO[352]||自动计算磨削位_校准数据-测头2-测头测量球半径
|LADAO[353]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度1_向右接触坐标_Z
|LADAO[354]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度1_向下接触坐标_Y
|LADAO[355]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度2_向右接触坐标_Z
|LADAO[356]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度2_向下接触坐标_Y
...
|LADAO[382]||测量基准-测头距离砂轮一-径向距离
|LADAO[383]||测量基准-测头距离砂轮一-轴向距离
...
|LADAO[389]||需加工齿数
|LADAO[390]||已加工齿数
|LADAO[391]||测量基准-测头距离砂轮二-径向距离
|LADAO[392]||测量基准-测头距离砂轮二-轴向距离
