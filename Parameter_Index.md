...
|LADAO[282]||通磨-自动计算起点.Y-砂轮直径补偿-测头测量点所在砂轮位置相对当前砂轮直径的偏移
|LADAO[283]||铲背-自动计算起点.Y-砂轮直径补偿-测头测量点所在砂轮位置相对当前砂轮直径的偏移
...
|LADAO[471]||退刀位置.Z
|LADAO[472]||通磨-自动计算起点.X-砂轮基准宽度
|LADAO[473]||铲背-自动计算起点.X-砂轮基准宽度
