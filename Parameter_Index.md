...
|$A_DBB[11]|DB4900.DBX11.0|修整轮左前当前状态(0停止/1启动)
|$A_DBB[12]|DB4900.DBX12.0|砂轮当前状态(0停止/1启动)
|$A_DBB[13]|DB4900.DBX13.0|修整轮左后当前状态(0停止/1启动)
...
|$A_DBB[27]|DB4900.DBX27.0|测头控制继电器故障检测(M97测头信号有效时此信号为0，无效为1)
|$A_DBB[28]|DB4900.DBX28.0|修整轮右前当前状态(0停止/1启动)
|$A_DBB[29]|DB4900.DBX29.0|修整轮右后当前状态(0停止/1启动)
|||与桁架机器人交互相关的信号
