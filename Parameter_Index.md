...
|LADAO[357]||自动计算磨削位_校准数据-A轴0度时测量杆和垂直方向的夹角  0.3
|LADAO[358]||自动计算磨削位_校准数据-基准长度(测量杆长度为0时)  411.22
|LADAO[359]||自动计算磨削位_校准数据-中心偏移(测量杆距离回转中心的偏移距离)  0
|LADAO[360]||
|LADAO[361]||
...
|LADAO[382]||测量基准-测头距离砂轮一-径向距离  ABS((-952.613+32/2)-(-1083.593+1))=145.98
...
|LADAO[389]||需加工齿数
|LADAO[390]||已加工齿数
|LADAO[391]||测量基准-测头距离砂轮二-径向距离  ABS((-952.563+32/2)-(-791.513+1))=146.05
