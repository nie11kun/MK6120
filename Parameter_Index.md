...
|LADAO[319]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_长度  106
|LADAO[320]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_直径  40
|LADAO[321]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴0度_向左接触坐标_Z  -531.76
|LADAO[322]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴0度_向下接触坐标_Y  -99.55
|LADAO[323]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴90度_向左接触坐标_Z  -1093.215
|LADAO[324]||自动计算磨削位_校准数据-砂轮1-基准磨杆2_B轴0度_A轴90度_向下接触坐标_Y  -137.15
...
|LADAO[333]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_长度  106
|LADAO[334]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_直径  40
|LADAO[335]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴0度_向左接触坐标_Z  -506.605
|LADAO[336]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴0度_向下接触坐标_Y  -99.55
|LADAO[337]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴90度_向左接触坐标_Z  -1061.355
|LADAO[338]||自动计算磨削位_校准数据-砂轮2-基准磨杆2_B轴180度_A轴90度_向下接触坐标_Y  -143.83
|LADAO[339]||自动计算磨削位_校准数据-砂轮2-基准长度(磨杆长度为0时)  169.235                      *****
|LADAO[340]||自动计算磨削位_校准数据-砂轮2-中心偏移(磨杆距离回转中心的偏移距离)  299.52           *****
|LADAO[341]||自动计算磨削位_校准数据-测头1-测头总长度(包括前端球)(测头1需长于测头2)  5+40+31.25
...
|LADAO[347]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度2_向右接触坐标_Z  -1558.403
|LADAO[348]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度2_向下接触坐标_Y  -184.76
|LADAO[349]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_测头收回去一定距离_向右接触坐标_Z  -1472.113
|LADAO[350]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_测头收回去一定距离_向下接触坐标_Y  -185.69
...
|LADAO[357]||自动计算磨削位_校准数据-测头-A轴0度时测量杆和垂直方向的夹角  0.3                     *****
|LADAO[358]||自动计算磨削位_校准数据-测头-基准长度(测量杆长度为0时)  411.22                      *****
|LADAO[359]||自动计算磨削位_校准数据-测头-中心偏移(测量杆距离回转中心的偏移距离)  0               *****
...
|LADAO[364]||自动计算磨削位_前角砂轮尖到端面距离(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到端面的距离)
...
|LADAO[383]||测量基准-测头距离砂轮一-轴向距离  LADAO[325]+LADAO[359]=175.928
|LADAO[384]||测量基准-测头距离砂轮一-垂直距离  LADAO[358]-LADAO[326]=411.22-299.52=111.7
...
|LADAO[392]||测量基准-测头距离砂轮二-轴向距离  LADAO[339]+LADAO[359]=169.235
|LADAO[393]||测量基准-测头距离砂轮二-垂直距离  LADAO[358]-LADAO[340]=411.22-299.52=111.7
|LADAO[394]||左前-滚轮垫圈厚度
|LADAO[395]||左后-滚轮垫圈厚度
|LADAO[396]||右前-滚轮垫圈厚度
|LADAO[397]||右后-滚轮垫圈厚度
...
|LADAO[471]||退刀位置.Z
|LADAO[472]||通磨-自动计算起点.X-测头测量点所在砂轮位置距砂轮端面距离
|LADAO[473]||铲背-自动计算起点.X-测头测量点所在砂轮位置距砂轮端面距离
|LADAO[474]||铲背-砂轮尖到端面距离
|LADAO[475]||自动计算磨削位_实际测量-测头相对回转中心虚拟半径
|LADAO[476]||自动计算磨削位_实际测量-测头虚拟半径和偏移距离长度的夹角
