...
|LADAO[360]||自动计算磨削位_实际测量-测头长度
|LADAO[361]||自动计算磨削位_实际测量-测头半径
|LADAO[362]||自动计算磨削位_实际测量-测头中心在第一齿前角R接触点的坐标.Z(自动赋值)
|LADAO[363]||自动计算磨削位_实际测量-测头中心在第一齿前角R接触点的坐标.Y(自动赋值)
|LADAO[364]||自动计算磨削位_砂轮磨削顶尖到砂轮端面的距离
|LADAO[365]||自动计算磨削位_砂轮磨削顶尖圆弧半径R
|LADAO[366]||最后一组数据-组号
|LADAO[367]||最后一组数据-齿距
