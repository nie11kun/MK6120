...
|PROCESS[18]||后角-起点自动计算-直径方向-起点到砂轮尖.Z
|PROCESS[19]||后角-起点自动计算-直径方向-起点到砂轮尖.Y
|PROCESS[20]||后角-起点自动计算-直径方向-砂轮基准偏移.X
|PROCESS[21]||厚度方向-当前砂轮直径
...
|TECHNOLOGY[262]||圆拉刀-后背侧面-头架转速-2
...
|SCREW_TAP[14]||手动铲磨动作比例系数(向下铲和向上抬的比值)
|SCREW_TAP[15]||手动铲磨动作铲背量
|SCREW_TAP[16]||B轴随动系数
...
|LADAO[26]||斜线进刀角度-垂直向下夹角
|LADAO[27]||自动测量当前测量齿槽
|LADAO[28]||自动测量底面相对前刃距离Z
|LADAO[29]||自动测量顶面相对前刃距离Z
|LADAO[30]||齿形参数：前刃角度-垂直向下夹角
|LADAO[31]||齿形参数：后背角度-水平方向夹角
|LADAO[32]||齿形参数：后背厚度
|LADAO[33]||齿形参数：顶部后刃角度-水平方向夹角
|LADAO[34]||齿形参数：当前齿齿距
|LADAO[35]||齿形参数：齿高
|LADAO[36]||测头半径
|LADAO[37]||加工选择(0前刃、1齿形平磨，2齿顶后刃，3齿侧后刃,4后背,5齿两端平面,6吸铁台面,7内圆加工,8螺纹)
...
|LADAO[92]||修整齿形齿高
|LADAO[93]||自动测量-测量位置(0全测/1前刃/2前刃and底面/3前角and后角/4前角and底面and后角)
...
|LADAO[152]||单滚轮-滚轮选择(0左前滚轮/1左后滚轮/2右前滚轮/3右后滚轮)
|LADAO[153]||滚压轮-滚轮选择(0左前滚轮/1左后滚轮/2右前滚轮/3右后滚轮)
|LADAO[154]||前滚压修整位X
|LADAO[155]||后滚压修整位X
|LADAO[156]||齿形程序存储位置(0内置/1后USB/2前USB)
|LADAO[157]||当前齿标准齿距累计(距离第一齿距离按标准齿距计算的距离)
|LADAO[158]||圆拉刀-通磨槽-磨削方式(0按槽计数/1按圈计数)
|LADAO[159]||正在进行前角靠磨后背工序标记
...
|LADAO[182]||前角-直接靠磨后背-齿型宽度补偿(定型齿为基准)
...
|LADAO[216]||铲背-X向补偿系数(当前齿总齿升量成系数就是当前齿x偏移量)
|LADAO[217]||铲背-磨削终点.X
|LADAO[218]||铲背-磨削步距.X
|LADAO[219]||拉刀类型(0平面拉刀/1圆拉刀)
|LADAO[220]||金刚笔-直径方向-修整基准.X
|LADAO[221]||金刚笔-直径方向-修整基准.Y
|LADAO[222]||金刚笔-直径方向-修整基准.Z
|LADAO[223]||金刚笔-直径方向-修整基准.A
|LADAO[224]||金刚笔-直径方向-修整基准.B
|LADAO[225]||金刚笔-厚度方向-修整基准.X
|LADAO[226]||金刚笔-厚度方向-修整基准.Y
|LADAO[227]||金刚笔-厚度方向-修整基准.Z
|LADAO[228]||金刚笔-厚度方向-修整基准.A
|LADAO[229]||金刚笔-厚度方向-修整基准.B
|LADAO[230]||金刚笔-直径方向-新砂轮实际Y接触滚轮
|LADAO[231]||金刚笔-直径方向-新砂轮实际直径
|LADAO[232]||金刚笔-厚度方向-新砂轮实际Y接触滚轮
|LADAO[233]||金刚笔-厚度方向-新砂轮实际厚度
|LADAO[234]||前滚轮-修整基准.Y
|LADAO[235]||后滚轮-修整基准.Y
|LADAO[236]||自动对刀-快速测量速度
|LADAO[237]||自动对刀-慢速测量速度
|LADAO[238]||测量杆总长
|LADAO[239]||圆心-z
|LADAO[240]||圆心-x
|LADAO[241]||圆心-Y
...
|LADAO[249]||后背起始偏置.Z
|LADAO[250]||齿平面起始偏置.Z
|LADAO[251]||吸铁台面起始偏置.Z
|LADAO[252]||前角斜线进刀(0否1是)
|LADAO[253]||后背斜线进刀(0否1是)
|LADAO[254]||内圆加工-磨削位.A
|LADAO[255]||内圆加工-磨削位.B
|LADAO[256]||是否有圆拉刀(0无1有)
|LADAO[257]||螺纹加工-X轴中心位
|LADAO[258]||圆拉刀-槽数
|LADAO[259]||圆拉刀-起始磨削槽
|LADAO[260]||圆拉刀-终止磨削槽
|LADAO[261]||圆拉刀-外径
|LADAO[262]||插补修整-左前-圆弧半径
|LADAO[263]||插补修整-左前-滚轮直径
|LADAO[264]||插补修整-左后-圆弧半径
|LADAO[265]||插补修整-左后-滚轮直径
|LADAO[266]||插补修整-右前-修整基准.X
|LADAO[267]||插补修整-右前-修整基准.Y
|LADAO[268]||插补修整-右前-修整基准.Z
|LADAO[269]||插补修整-右前-圆弧半径
|LADAO[270]||插补修整-右前-滚轮直径
|LADAO[271]||插补修整-右后-修整基准.X
|LADAO[272]||插补修整-右后-修整基准.Y
|LADAO[273]||插补修整-右后-修整基准.Z
|LADAO[274]||插补修整-右后-圆弧半径
|LADAO[275]||插补修整-右后-滚轮直径
|LADAO[276]||直径方向-齿顶圆弧半径
|LADAO[277]||圆拉刀-前角-A轴补偿角
|LADAO[278]||圆拉刀-后背-A轴补偿角
|LADAO[279]||前角靠后背-粗磨进给量上限
|LADAO[280]||前角靠后背-粗磨进给量下限
|LADAO[281]||圆拉刀-通磨-加工方式(0通磨槽/1通磨外圆)
|LADAO[282]||通磨-自动计算起点.Y-砂轮直径补偿-测头测量点所在砂轮位置相对当前砂轮起始修整点的偏移
|LADAO[283]||铲背-自动计算起点.Y-砂轮直径补偿-测头测量点所在砂轮位置相对当前砂轮起始修整点的偏移
|LADAO[284]||砂轮选择(0砂轮一/1砂轮二)
|LADAO[285]||砂轮二-插补修整-左前-修整基准.X
|LADAO[286]||砂轮二-插补修整-左前-修整基准.Y
|LADAO[287]||砂轮二-插补修整-左前-修整基准.Z
|LADAO[288]||砂轮二-插补修整-左后-修整基准.X
|LADAO[289]||砂轮二-插补修整-左后-修整基准.Y
|LADAO[290]||砂轮二-插补修整-左后-修整基准.Z
|LADAO[291]||砂轮二-插补修整-右前-修整基准.X
|LADAO[292]||砂轮二-插补修整-右前-修整基准.Y
|LADAO[293]||砂轮二-插补修整-右前-修整基准.Z
|LADAO[294]||砂轮二-插补修整-右后-修整基准.X
|LADAO[295]||砂轮二-插补修整-右后-修整基准.Y
|LADAO[296]||砂轮二-插补修整-右后-修整基准.Z
|LADAO[297]||螺线槽-修磨角度差
|LADAO[298]||圆拉刀-通磨-通磨槽-c起始角调整
|LADAO[299]||圆拉刀-铲背-c起始角调整
|LADAO[300]||圆拉刀-铲背-偶数齿C轴偏置角
|LADAO[301]||第1组齿距
|LADAO[302]||第2组齿距
|LADAO[303]||第3组齿距
|LADAO[304]||第4组齿距
...
|LADAO[309]||第9组齿距
|LADAO[310]||第10组齿距
|LADAO[311]||平面拉刀-通磨-x轴向补偿系数
|LADAO[312]||测头-砂轮-相对位置计算(0否1是)
|LADAO[313]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_长度(磨杆1需要长于磨杆2) 125
|LADAO[314]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_直径  32
|LADAO[315]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴0度_向左接触坐标_Z  -512.76
|LADAO[316]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴0度_向下接触坐标_Y  -103.55
|LADAO[317]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴90度_向左接触坐标_Z  -1097.215
|LADAO[318]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴90度_向下接触坐标_Y  -118.15
|LADAO[319]||自动计算磨削位_圆拉刀-通磨外圆砂轮尖到修整起点水平距离Z(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到修整起点的距离)
|LADAO[320]||自动计算磨削位_圆拉刀-通磨外圆砂轮尖到修整起点垂直距离Y(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到修整起点的距离)
|LADAO[321]||自动测量-通磨槽-最大分度误差
|LADAO[322]||自动测量-通磨槽-最大齿向误差
|LADAO[323]||自动测量-是否测量齿轮齿轮精度(0否/1分度测量/2外径测量)
|LADAO[324]||自动测量-测量齿轮齿槽-齿槽长度
|LADAO[325]||自动计算磨削位_校准数据-砂轮1-基准长度(磨杆长度为0时)  175.928                     *****
|LADAO[326]||自动计算磨削位_校准数据-砂轮1-中心偏移(磨杆距离回转中心偏移)  299.52                *****
|LADAO[327]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_长度(磨杆1需要长于磨杆2)  125
|LADAO[328]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_直径  32
|LADAO[329]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴0度_向左接触坐标_Z  -487.605
|LADAO[330]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴0度_向下接触坐标_Y  -103.55
|LADAO[331]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴90度_向左接触坐标_Z -1065.355
|LADAO[332]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴180度_A轴90度_向下接触坐标_Y -124.83
|LADAO[333]||自动测量-通磨槽-最大外径误差
|LADAO[334]||输入输出信号检测模式(0:$A_DBB/1:$A_IN)
|LADAO[335]||自动对刀-测量第一齿齿侧面测量方向.X(1正向 -1负向)
|LADAO[336]||自动对刀-测量齿数量(0全测  1测第一齿)
|LADAO[337]||自动对刀-测量齿实际数量
|LADAO[338]||自动计算磨削位_前角-砂轮基准偏移.X
|LADAO[339]||自动计算磨削位_校准数据-砂轮2-基准长度(磨杆长度为0时)  169.235                      *****
|LADAO[340]||自动计算磨削位_校准数据-砂轮2-中心偏移(磨杆距离回转中心的偏移距离)  299.515           *****
|LADAO[341]||自动计算磨削位_校准数据-测头1-测头总长度(包括前端球)  5+40+31.25
|LADAO[342]||自动计算磨削位_校准数据-测头1-测头测量球半径  1mm
|LADAO[343]||自动计算磨削位_校准数据-A轴测量角度1(大于零的一个角度)  10
|LADAO[344]||自动计算磨削位_校准数据-A轴测量角度2(大于角度1的一个角度)  20
|LADAO[345]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_向右接触坐标_Z  -1475.633
|LADAO[346]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_向下接触坐标_Y  -166.33
|LADAO[347]||前角 后背-齿顶齿底进刀量设置-用于顶面没有进刀量但齿底有进刀量或相反情况加工(0同步齿升 1底有顶无 -1底无顶有)
|LADAO[348]||自动计算后背磨削位_前角砂轮尖到修整起点水平距离Z(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到修整起点的距离)
|LADAO[349]||自动计算后背磨削位_前角砂轮尖到修整起点垂直距离(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到修整起点的垂直距离)
|LADAO[350]||自动计算后背磨削位_前角-齿深偏移距离
|LADAO[351]||自动计算磨削位_校准数据-测头2-测头总长度(包括前端球)  5+31.25
|LADAO[352]||自动计算磨削位_校准数据-测头2-测头测量球半径  1mm
|LADAO[353]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度1_向右接触坐标_Z  -1468.683
|LADAO[354]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度1_向下接触坐标_Y  -205.66
|LADAO[355]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度2_向右接触坐标_Z  -1544.713
|LADAO[356]||自动计算磨削位_校准数据-测头2-B轴0度_A轴测量角度2_向下接触坐标_Y  -222.25
|LADAO[357]||自动计算磨削位_校准数据-测头-A轴0度时测量杆和垂直方向的夹角 正值则向A轴正向偏  0.021                     *****
|LADAO[358]||自动计算磨削位_校准数据-测头-基准长度(测量杆长度为0时)  411.22                      *****
|LADAO[359]||自动计算磨削位_校准数据-测头-中心偏移(测量杆距离回转中心的偏移距离) 偏移方向为回转中心向右为正值  0               *****
|LADAO[360]||自动计算磨削位_校准数据-砂轮1-基准磨杆1_B轴0度_A轴0度_向前接触坐标_X  -888.613
|LADAO[361]||自动计算磨削位_校准数据-砂轮2-基准磨杆1_B轴0度_A轴0度_向前接触坐标_X  -888.683
|LADAO[362]||自动计算磨削位_实际测量-测头中心在第一齿前角顶尖接触点的坐标.Z(测头需要A轴0度时测量)
|LADAO[363]||自动计算磨削位_实际测量-测头中心在第一齿前角顶尖接触点的坐标.Y(测头需要A轴0度时测量)
|LADAO[364]||自动计算磨削位_前角砂轮尖到修整起点水平距离Z(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到修整起点的距离)
|LADAO[365]||自动计算磨削位_校准数据-测头1-B轴0度_A轴测量角度1_向前接触坐标_X   -757.633
|LADAO[366]||最后一组数据-组号
|LADAO[367]||最后一组数据-齿距
|LADAO[368]||最后一组数据-齿升量
|LADAO[369]||标准全长齿距
|LADAO[370]||圆拉刀-磨削基准-B轴0度-头架中心-砂轮一-基准.X
|LADAO[371]||圆拉刀-磨削基准-B轴0度-头架中心-砂轮一-基准.Y
|LADAO[372]||圆拉刀-磨削基准-B轴0度-头架中心-砂轮一-基准.Z
|LADAO[373]||圆拉刀-磨削基准-B轴0度-头架中心-砂轮二-基准.X
|LADAO[374]||圆拉刀-磨削基准-B轴0度-头架中心-砂轮二-基准.Y
|LADAO[375]||圆拉刀-磨削基准-B轴0度-头架中心-砂轮二-基准.Z
|LADAO[376]||圆拉刀-磨削基准-B轴90度-头架中心-砂轮一-基准.X
|LADAO[377]||圆拉刀-磨削基准-B轴90度-头架中心-砂轮一-基准.Y
|LADAO[378]||圆拉刀-磨削基准-B轴90度-头架中心-砂轮一-基准.Z
|LADAO[379]||圆拉刀-磨削基准-B轴-90度-头架中心-砂轮二-基准.X
|LADAO[380]||圆拉刀-磨削基准-B轴-90度-头架中心-砂轮二-基准.Y
|LADAO[381]||圆拉刀-磨削基准-B轴-90度-头架中心-砂轮二-基准.Z
|LADAO[382]||测量基准-测头距离砂轮一-径向距离  ABS((LADAO[360]-LADAO[314]/2)-(LADAO[365]-LADAO[342]))=145.98
|LADAO[383]||测量基准-测头基准长度下距离砂轮一-轴向距离  LADAO[325]+LADAO[359]=175.928
|LADAO[384]||测量基准-测头基准长度下距离砂轮一-垂直距离  LADAO[358]-LADAO[326]=411.22-299.52=111.7
|LADAO[385]||自动计算磨削位_前角-齿深偏移距离
|LADAO[386]||通磨槽-砂轮中心在头架中心上的偏移距离x
|LADAO[387]||需加工槽数
|LADAO[388]||已加工槽数
|LADAO[389]||需加工齿数
|LADAO[390]||已加工齿数
|LADAO[391]||测量基准-测头距离砂轮二-径向距离  ABS((LADAO[361]-LADAO[328]/2)-(LADAO[365]-LADAO[342]))=146.05
|LADAO[392]||测量基准-测头基准长度下距离砂轮二-轴向距离  LADAO[339]+LADAO[359]=169.235
|LADAO[393]||测量基准-测头基准长度下距离砂轮二-垂直距离  LADAO[358]-LADAO[340]=411.22-299.52=111.7
|LADAO[394]||左前-滚轮垫圈厚度
|LADAO[395]||左后-滚轮垫圈厚度
|LADAO[396]||右前-滚轮垫圈厚度
|LADAO[397]||右后-滚轮垫圈厚度
|LADAO[398]||左前-滚轮端面到圆弧厚度
|LADAO[399]||左后-滚轮端面到圆弧厚度
|LADAO[400]||右前-滚轮端面到圆弧厚度
|LADAO[401]||右后-滚轮端面到圆弧厚度
|LADAO[402]||通磨-齿距模式(0测量1标准)
|LADAO[403]||后角-齿升量模式(0后角测量/1前角测量/2标准)
|LADAO[404]||铲背-齿升量模式(0后角测量/1前角测量/2标准)
|LADAO[405]||厚度方向-砂轮一-插补修整-左前-修整基准.X
|LADAO[406]||厚度方向-砂轮一-插补修整-左前-修整基准.Y
|LADAO[407]||厚度方向-砂轮一-插补修整-左前-修整基准.Z
|LADAO[408]||厚度方向-砂轮二-插补修整-左前-修整基准.X
|LADAO[409]||厚度方向-砂轮二-插补修整-左前-修整基准.Y
|LADAO[410]||厚度方向-砂轮二-插补修整-左前-修整基准.Z
|LADAO[411]||厚度方向-砂轮一-插补修整-左后-修整基准.X
|LADAO[412]||厚度方向-砂轮一-插补修整-左后-修整基准.Y
|LADAO[413]||厚度方向-砂轮一-插补修整-左后-修整基准.Z
|LADAO[414]||厚度方向-砂轮二-插补修整-左后-修整基准.X
|LADAO[415]||厚度方向-砂轮二-插补修整-左后-修整基准.Y
|LADAO[416]||厚度方向-砂轮二-插补修整-左后-修整基准.Z
|LADAO[417]||厚度方向-砂轮一-插补修整-右前-修整基准.X
|LADAO[418]||厚度方向-砂轮一-插补修整-右前-修整基准.Y
|LADAO[419]||厚度方向-砂轮一-插补修整-右前-修整基准.Z
|LADAO[420]||厚度方向-砂轮二-插补修整-右前-修整基准.X
|LADAO[421]||厚度方向-砂轮二-插补修整-右前-修整基准.Y
|LADAO[422]||厚度方向-砂轮二-插补修整-右前-修整基准.Z
|LADAO[423]||厚度方向-砂轮一-插补修整-右后-修整基准.X
|LADAO[424]||厚度方向-砂轮一-插补修整-右后-修整基准.Y
|LADAO[425]||厚度方向-砂轮一-插补修整-右后-修整基准.Z
|LADAO[426]||厚度方向-砂轮二-插补修整-右后-修整基准.X
|LADAO[427]||厚度方向-砂轮二-插补修整-右后-修整基准.Y
|LADAO[428]||厚度方向-砂轮二-插补修整-右后-修整基准.Z
|LADAO[429]||厚度方向-砂轮一-滚压修整-左前-修整基准.X
|LADAO[430]||厚度方向-砂轮一-滚压修整-左前-修整基准.Y
|LADAO[431]||厚度方向-砂轮一-滚压修整-左前-修整基准.Z
|LADAO[432]||厚度方向-砂轮二-滚压修整-左前-修整基准.X
|LADAO[433]||厚度方向-砂轮二-滚压修整-左前-修整基准.Y
|LADAO[434]||厚度方向-砂轮二-滚压修整-左前-修整基准.Z
|LADAO[435]||厚度方向-砂轮一-滚压修整-左后-修整基准.X
|LADAO[436]||厚度方向-砂轮一-滚压修整-左后-修整基准.Y
|LADAO[437]||厚度方向-砂轮一-滚压修整-左后-修整基准.Z
|LADAO[438]||厚度方向-砂轮二-滚压修整-左后-修整基准.X
|LADAO[439]||厚度方向-砂轮二-滚压修整-左后-修整基准.Y
|LADAO[440]||厚度方向-砂轮二-滚压修整-左后-修整基准.Z
|LADAO[441]||厚度方向-砂轮一-滚压修整-右前-修整基准.X
|LADAO[442]||厚度方向-砂轮一-滚压修整-右前-修整基准.Y
|LADAO[443]||厚度方向-砂轮一-滚压修整-右前-修整基准.Z
|LADAO[444]||厚度方向-砂轮二-滚压修整-右前-修整基准.X
|LADAO[445]||厚度方向-砂轮二-滚压修整-右前-修整基准.Y
|LADAO[446]||厚度方向-砂轮二-滚压修整-右前-修整基准.Z
|LADAO[447]||厚度方向-砂轮一-滚压修整-右后-修整基准.X
|LADAO[448]||厚度方向-砂轮一-滚压修整-右后-修整基准.Y
|LADAO[449]||厚度方向-砂轮一-滚压修整-右后-修整基准.Z
|LADAO[450]||厚度方向-砂轮二-滚压修整-右后-修整基准.X
|LADAO[451]||厚度方向-砂轮二-滚压修整-右后-修整基准.Y
|LADAO[452]||厚度方向-砂轮二-滚压修整-右后-修整基准.Z
|LADAO[453]||厚度方向-插补-两端面基准坐标.Y
|LADAO[454]||厚度方向-插补-两端面基准坐标.Z
|LADAO[455]||厚度方向-成型-两端面基准坐标.Y
|LADAO[456]||厚度方向-成型-两端面基准坐标.Z
|LADAO[457]||通磨-通磨槽-磨圆弧(0否/1是)
|LADAO[458]||通磨-通磨槽-磨圆弧-圆弧类型(0凸圆弧 1凹圆弧)
|LADAO[459]||通磨-通磨槽-磨圆弧-中心相对工件左端偏移(向左为负 向右为正)
|LADAO[460]||通磨-通磨槽-磨圆弧-磨削长度
|LADAO[461]||通磨-通磨槽-磨圆弧-圆弧半径
|LADAO[462]||通磨-通磨槽-磨圆弧-圆弧半径补偿
|LADAO[463]||自动对刀-第一齿前角实测.Z
|LADAO[464]||自动对刀-第一齿后角实测.Y
|LADAO[465]||自动对刀-是否测量第一齿齿侧面(0否1是) -- 用来计算通磨起始X
|LADAO[466]||自动对刀-测量第一齿齿侧面.X
|LADAO[467]||自动对刀-测量第一齿齿侧面.Y
|LADAO[468]||自动对刀-测量第一齿齿侧面测量值.X
|LADAO[469]||自动对刀-测量第一齿齿侧面.Z
|LADAO[470]||加工磨削齿顺序(0从前往后递增 1从后往前递减)
|LADAO[471]||退刀位置.Z
|LADAO[472]||通磨-自动计算起点.X-测头测量点距离砂轮中心磨削位置偏移距离x
|LADAO[473]||铲背-自动计算起点.X-测头测量点距离砂轮中心磨削位置偏移距离x
|LADAO[474]||铲背-砂轮中心在头架中心上的偏移距离x
|LADAO[475]||自动计算磨削位_实际测量-测头中心相对回转中心虚拟半径
|LADAO[476]||自动计算磨削位_实际测量-测头杆和虚拟半径的夹角
|LADAO[477]||自动计算磨削位_实际测量-测头测量时虚拟半径垂直向下的夹角
|LADAO[478]||自动计算磨削位_前角砂轮尖到修整起点垂直距离(将齿型沿齿底前角后背长度线处构造为一个梯形后 前角侧齿尖到修整起点的垂直距离)
|LADAO[479]||自动计算磨削位_后背-砂轮基准偏移.X
|LADAO[480]||测头实际位置校准(0否1是)
|LADAO[481]||基准测头球中心相对-砂轮回转中心.X
|LADAO[482]||基准测头球中心相对-砂轮回转中心.Y
|LADAO[483]||基准测头杆长为0时相对-砂轮回转中心.Z
|LADAO[484]||基准测头球半径
|LADAO[485]||基准测头球测量起始.X
|LADAO[486]||基准测头球测量起始.Y
|LADAO[487]||基准测头球测量起始.Z
|LADAO[488]||基准测量杆总长
|LADAO[489]||自动对刀-测量第一齿齿侧-测量角度(0度测量垂直面  非0则为测量标准棒)
|LADAO[490]||自动对刀-测量第一齿齿侧-测量标准棒直径
|LADAO[491]||自动对刀-测量第一齿齿侧-测量标准棒顶部坐标.Z
|LADAO[492]||自动对刀-测量第一齿齿侧-测量标准棒顶部坐标.Y
|LADAO[493]||自动对刀-测量第一齿基准-顶面测量.X
|LADAO[494]||自动对刀-测量第一齿基准-顶面测量.Y
|LADAO[495]||自动对刀-测量第一齿基准-顶面测量.Z
|LADAO[496]||自动对刀-测量第一齿基准-顶面测量值.Z
|LADAO[497]||自动对刀-测量第一齿基准-顶面测量值.Y
|LADAO[498]||自动对刀-是否有第二基准测头(0无1有)
|LADAO[499]||历史记录恢复行号
|LADAO[500]||是否有左后修整器(0无1有)
|LADAO[501]||平拉刀铲背进刀方向设置参数显示(0无1有)
|LADAO[502]||平拉刀铲背进刀方向(0_Y向下/1_X向正/-1_X向负)
|LADAO[503]||平拉刀铲背x向进刀累计量 批量单件启动后都会清空
|LADAO[504]||历史记录-是否恢复工件数据(0否1是)
|LADAO[505]||历史记录-工件数据存储计数
|||
...
|MEASURE_RESULT[1950]||顶部后刃测量累计偏移1
|MEASURE_RESULT[2099]||顶部后刃测量累计偏移150
|MEASURE_RESULT[2100]||底面测量累计偏移1
|MEASURE_RESULT[2250]||底面测量累计偏移150
|||
...
|TECH_ADDED[238]||
|TECH_ADDED[239]||
|TECH_ADDED[240]||前角靠后背-水平-粗磨单双
|TECH_ADDED[241]||前角靠后背-水平-粗磨次数
|TECH_ADDED[242]||前角靠后背-水平-粗磨进给量
|TECH_ADDED[243]||前角靠后背-水平-粗磨速度
|TECH_ADDED[244]||前角靠后背-水平-粗磨是否修整
|TECH_ADDED[245]||前角靠后背-水平-粗磨砂轮线速度
|TECH_ADDED[246]||前角靠后背-水平-粗磨砂轮转速
|TECH_ADDED[247]||前角靠后背-水平-粗磨头架转速
|TECH_ADDED[248]||前角靠后背-水平-设定工艺总量
|TECH_ADDED[249]||
|TECH_ADDED[250]||前角靠后背-水平-半精磨单双
|TECH_ADDED[251]||前角靠后背-水平-半精磨次数
|TECH_ADDED[252]||前角靠后背-水平-半精磨进给量
|TECH_ADDED[253]||前角靠后背-水平-半精磨速度
|TECH_ADDED[254]||前角靠后背-水平-半精磨是否修整
|TECH_ADDED[255]||前角靠后背-水平-半精磨砂轮线速度
|TECH_ADDED[256]||前角靠后背-水平-半精磨砂轮转速
|TECH_ADDED[257]||前角靠后背-水平-半精磨头架转速
|TECH_ADDED[258]||
|TECH_ADDED[259]||
|TECH_ADDED[260]||前角靠后背-水平-精磨单双
|TECH_ADDED[261]||前角靠后背-水平-精磨次数
|TECH_ADDED[262]||前角靠后背-水平-精磨进给量
|TECH_ADDED[263]||前角靠后背-水平-精磨速度
|TECH_ADDED[264]||前角靠后背-水平-精磨是否修整
|TECH_ADDED[265]||前角靠后背-水平-精磨砂轮线速度
|TECH_ADDED[266]||前角靠后背-水平-精磨砂轮转速
|TECH_ADDED[267]||前角靠后背-水平-精磨头架转速
|TECH_ADDED[268]||
|TECH_ADDED[269]||
|TECH_ADDED[270]||前角靠后背-水平-终磨单双
|TECH_ADDED[271]||前角靠后背-水平-终磨次数
|TECH_ADDED[272]||前角靠后背-水平-终磨进给量
|TECH_ADDED[273]||前角靠后背-水平-终磨速度
|TECH_ADDED[274]||前角靠后背-水平-终磨是否修整
|TECH_ADDED[275]||前角靠后背-水平-终磨砂轮线速度
|TECH_ADDED[276]||前角靠后背-水平-终磨砂轮转速
|TECH_ADDED[277]||前角靠后背-水平-终磨头架转速
|TECH_ADDED[278]||
|TECH_ADDED[279]||
